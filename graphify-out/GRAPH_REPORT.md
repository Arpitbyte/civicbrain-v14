...
### Community 1 - "transparency-board/src/App.tsx"
Cohesion: 0.15
...
Cohesion: 0.21
Nodes (11): fakeredis_aioredis, asyncio, Integration tests for citizen intake and operational incidents APIs., Verify tracking endpoint returns 404 for nonexistent token., Verify Redis-backed IP rate limiting on anonymous tracking token endpoint., Verify /v1/incidents returns empty list for empty or non-existent org., Verify /v1/taxonomy/categories returns empty list for org with no categories., test_incidents_listing_nonexistent_org() (+3 more)
...
Cohesion: 0.05
Nodes (43): create_causal_link(), get_downstream_symptoms(), AsyncSession, get, post, UUID, Retrieve all downstream symptom incidents and priority boost breakdown., Create a causal link with strict multi-hop cycle prevention and staff… (+35 more)
...
### Community 36 - "PIIScrubbingFilter"
Cohesion: 0.21
...
Cohesion: 0.08
Nodes (31): PROMPT 4 — Tier 1 Civic-Specific Components, [2026-09-24] — PROMPT 4 — Tier 1 Civic-Specific Components (packages/ui), BeforeAfterPair(), BeforeAfterPairProps, CivicShowcase(), WORKSPACES, EvidencePhotoCard(), EvidencePhotoCardProps (+23 more)
...
### Community 43 - "primitives/index.ts"
Cohesion: 0.06
Nodes (25): BadgeProps, BadgeSize, BadgeVariant, Chip, ButtonProps, ButtonSize, ButtonVariant, IconButtonProps (+17 more)
...
Cohesion: 0.07
Nodes (28): ANTIGRAVITY_PROMPTS.md — CivicBrain Implementation Prompts, Implementation order, PROMPT 0 — Foundation: Tokens & Repo Scaffold, PROMPT 10 — Representative Screen: Control Room · AHP Weight Calibration, PROMPT 11 — Representative Screen: Transparency Board · Nagar Pragati, PROMPT 34 — Responsive Refinement Pass, PROMPT 35 — Motion Pass, PROMPT 36 — Accessibility Pass (+20 more)

### Community 48 - "test_security_performance_hardening.py"
Cohesion: 0.13
Nodes (20): Any, Upstash Redis connection and rate limiting client., Overrides redis client (used for testing or dependency injection)., set_redis_client(), 2. Verification & Test Evidence, redis_asyncio, asyncio, Comprehensive verification tests for Security and Performance Hardening pass. (+12 more)
...
Cohesion: 0.08
Nodes (41): ClusterAccessibleListView(), ClusterAccessibleListViewProps, ClusterData, ClusterStatsPanel(), ClusterStatsPanelProps, CoordinateRulerFrame(), CoordinateRulerFrameProps, GsapClusterRevealOptions (+33 more)

### Community 53 - "test_nlp_pipeline.py"
Cohesion: 0.15
Nodes (13): httpx, asyncio, Smoke and integration tests for health and readiness endpoints., Verify that /v1/health returns HTTP 200 and expected liveness schema., Verify that /v1/ready returns valid readiness response format., Verify that root endpoint provides documentation links., test_health_endpoint_liveness(), test_ready_endpoint_schema() (+5 more)

### Community 54 - "ref_react"
Cohesion: 0.13
Nodes (15): App(), apps_nagrik_setu_src_index, root, HomeReportView(), ReportCaptureView(), ReportCategoryView(), ReportLocationView(), ReportReviewView() (+7 more)
...
### Community 68 - "uuid"
Cohesion: 0.07
Nodes (37): Application configuration via pydantic-settings., postgrest_exceptions, pydantic_settings, pytest, supabase, Unit tests for Phase 7 Causal Root-Cause Linking & Incident Graph Centrality…, is_live_supabase_configured(), Live Supabase Phase 12 Exhaustive RLS & Privilege Matrix Audit Test Suite. In… (+29 more)
...
### Community 74 - "0. Complete sitemap (4 deployables, per `UI_ARCHITECTURE.md` §1)"
Cohesion: 0.25
...
### Community 85 - "karmi-sahayak/src/App.tsx"
Cohesion: 0.15
Nodes (19): FieldLayout(), OfflineSyncContext, OfflineSyncContextValue, OfflineSyncProvider(), useOfflineSync(), getQueuedMutations(), QueuedMutation, removeMutation() (+11 more)
...
### Community 87 - "test_live_supabase_phase9_sync_and_adjudication_flow"
Cohesion: 0.67
...
Cohesion: 0.09
Nodes (41): PROMPT 3 — Tier 0 Primitives, [2026-09-24] — PROMPT 3 — Tier 0 Primitives (packages/ui), 1. Shared component architecture (`packages/ui`), Badge(), Checkbox(), Dialog(), Drawer(), EmptyState() (+33 more)
...
### Community 94 - "test_live_supabase_rls.py"
Cohesion: 0.29
...
Cohesion: 0.19
Nodes (13): PROMPT 1 — Shared App Shells, [2026-09-24] — PROMPT 0 — Foundation: Tokens & Repo Scaffold (none), [2026-09-24] — PROMPT 1 — Shared App Shells (all four deployables), [2026-09-24] — PROMPT 5 — Representative Screen: Nagrik Setu · Track Report (apps/nagrik-setu), [2026-09-24] — PROMPT 6 — Representative Screen: Command Deck · Incident Detail (apps/staff-console), [2026-09-24] — PROMPT 9 — Representative Screen: Karmi Sahayak · Work Order Action (apps/karmi-sahayak), Entry template (copy this for every new entry), IMPLEMENTATION_LOG.md — CivicBrain Build History (+5 more)
...
### Community 123 - "test_live_supabase_phase3_rls"
Cohesion: 0.50
...
Cohesion: 0.08
Nodes (25): AhpWeightCalibrationView(), BulkImportView(), CausalGraphView(), ConflictAdjudicationView(), CouncilorDigestView(), DepartmentQueueView(), EtaConfidenceView(), IncidentQueueView() (+17 more)

### Community 132 - "TrackingTokenDisplay"
Cohesion: 0.16
Nodes (12): 2.1 Home / Report an Issue, 2.2 New Report Flow (`capture` → `location` → `category` → `review`), 2.3 Track Report (lookup + detail), NAGRIK SETU, TrackingTokenDisplay(), TrackingTokenDisplayProps, ToastContext, ToastContextType (+4 more)

### Community 134 - "test_live_supabase_phase5_nlp"
Cohesion: 0.67
...
Cohesion: 0.05
Nodes (39): dependencies, @civicbrain/design-tokens, lucide-react, @radix-ui/react-checkbox, @radix-ui/react-dialog, @radix-ui/react-radio-group, @radix-ui/react-select, @radix-ui/react-switch (+31 more)
...
### Community 141 - "test_live_supabase_phase8_dispatch_evidence_gate"
Cohesion: 0.67
...
- **Why does `[2026-09-24] — PROMPT 4 — Tier 1 Civic-Specific Components (packages/ui)` connect `CivicShowcase.tsx` to `v1/prioritization.py`, `TrackingTokenDisplay`, `ANTIGRAVITY_PROMPTS.md — CivicBrain Implementation Prompts`, `StatusTimeline`, `IMPLEMENTATION_LOG.md — CivicBrain Build History`?**
  _High betweenness centrality (0.282) - this node is a cross-community bridge._
