...
## Corpus Check
- 286 files · ~146,733 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 56 file(s) not represented in the graph (top: .css 42, .woff2 9, (none) 3)

## Summary
- 2424 nodes · 5010 edges · 138 communities (108 shown, 30 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 653 edges (avg confidence: 0.95)
...
### Community 1 - "civic/index.ts"
Cohesion: 0.11
Nodes (13): BeforeAfterPairProps, ConfidenceBadgeProps, ConfidenceBand, EvidencePhotoCardProps, ClusterLayerProps, IncidentPointLayerProps, WardBoundaryMapLayerProps, PriorityChipProps (+5 more)
...
Cohesion: 0.16
Nodes (16): GeoJSONFeatureCollection, IncidentClusterResponse, BaseModel, Geospatial and GeoJSON schemas for GIS Core (§A14)., RFC 7946 GeoJSON FeatureCollection representation., Detected defect density hotspot cluster (§A14)., asyncio, Unit tests for GIS Core, GeoJSON serialization, and bounding-box validation… (+8 more)
...
Cohesion: 0.11
Nodes (32): CitizenVerificationMethod, Urban Local Body classification under 74th Constitutional Amendment Act, 1992., Citizen identity verification methods per §A8., ULBType, BaseSchema, CitizenProfileCreate, CitizenProfileResponse, DepartmentBase (+24 more)
...
Cohesion: 0.11
Nodes (25): MOCK_FIXTURES, ReportTrackData, TrackDetailView(), getValidNextStatuses(), STATUS_LABELS, VALID_NEXT_STATUS_TRANSITIONS, CausalLinkItem, IncidentDetailData (+17 more)

### Community 34 - "v1/prioritization.py"
Cohesion: 0.07
Nodes (51): evaluate_incident_priority(), get_active_ahp_matrix(), get_ward_equity(), AsyncSession, get, post, UUID, API endpoints for Phase 6 AHP Prioritization, Equity Compensator & Confidence… (+43 more)

### Community 35 - "hierarchy.py"
Cohesion: 0.10
Nodes (25): bulk_import_users(), normalize_indian_phone(), UploadFile, Administrative hierarchy, department taxonomy, and representative discovery…, Bulk import staff users for non-admin operational roles from a CSV file.…, Validate and normalize Indian phone number to E.164 +91XXXXXXXXXX format., Explicit role assignment for staff users with optional department, zone, or…, Audit record for administrative staff bulk-import events. (+17 more)

### Community 36 - "AHPMatrix"
Cohesion: 0.12
...
Cohesion: 0.05
Nodes (88): ANTIGRAVITY_PROMPTS.md — CivicBrain Implementation Prompts, Implementation order, PROMPT 0 — Foundation: Tokens & Repo Scaffold, PROMPT 10 — Representative Screen: Control Room · AHP Weight Calibration, PROMPT 11 — Representative Screen: Transparency Board · Nagar Pragati, PROMPT 1 — Shared App Shells, PROMPT 34 — Responsive Refinement Pass, PROMPT 35 — Motion Pass (+80 more)
...
Cohesion: 0.04
Nodes (40): OfflineSyncBadgeProps, TrackingTokenDisplayProps, NavTabBarProps, BadgeProps, BadgeSize, BadgeVariant, Chip, CheckboxProps (+32 more)
...
### Community 45 - "2. Verification & Test Evidence"
Cohesion: 0.17
Nodes (13): 2. Verification & Test Evidence, Phase 13: Security & Performance Hardening — Implementation Log, asyncio, 5. Verify generalized IP rate limiter protects POST /v1/intake/reports., 1. Verify standard defensive security headers injected on all HTTP responses., 2. Verify CORS allows only explicit origins and forbids wildcard '*'., 3. Verify unhandled exceptions return generic message without leaking trace or…, 4. Verify photo uploads exceeding 10MB are rejected with 413 Payload Too Large. (+5 more)

### Community 46 - "identity/services.py"
Cohesion: 0.11
Nodes (32): get_my_profile(), AsyncSession, get, Returns the authenticated identity, role assignments, and jurisdictional scopes…, get_hierarchy(), Retrieve complete tree of zones and wards for an organization., CitizenProfile, Administrative subdivision of a ULB. (+24 more)

### Community 47 - "2. Screen specifications"
Cohesion: 0.06
Nodes (32): 0.1 `apps/nagrik-setu` (public, anon + Phone OTP), 0.2 `apps/staff-console` (authenticated, role-gated — Command Deck / Ops Board / City Pulse / Control Room), 0.3 `apps/karmi-sahayak` (field_worker, offline-first PWA), 0.4 `apps/transparency-board` (Astro, public + corporator auth), 0. Complete sitemap (4 deployables, per `UI_ARCHITECTURE.md` §1), 2.10 Department Queue, 2.11 Work Order Detail, 2.12 Heatmap / Cluster View (+24 more)

### Community 48 - "test_security_performance_hardening.py"
Cohesion: 0.09
Nodes (30): cache_delete(), cache_get(), cache_set(), Any, Upstash Redis caching layer for hot, rarely-changing public reads., Retrieves JSON-deserialized value from Redis cache. Fails open on connection…, Stores JSON-serialized value into Redis cache with specified TTL. Fails open on…, Deletes cached key upon invalidation. Fails open on error. (+22 more)
...
Cohesion: 0.05
Nodes (105): adjudicate_conflict(), create_new_work_order(), execute_field_sync(), get_worker_sync_conflicts(), list_my_work_orders(), list_supervisor_conflicts(), AsyncSession, get (+97 more)

### Community 51 - "test_hierarchy_api.py"
Cohesion: 0.19
...
Cohesion: 0.06
Nodes (37): ClusterAccessibleListView(), ClusterAccessibleListViewProps, ClusterData, ClusterStatsPanel(), ClusterStatsPanelProps, CoordinateRulerFrame(), CoordinateRulerFrameProps, IncidentCluster (+29 more)

### Community 53 - "v1/gis.py"
Cohesion: 0.27
Nodes (12): get_clusters(), get_incidents_geojson(), get_wards_geojson(), AsyncSession, get, UUID, GIS Core and Spatial Analysis REST Endpoints (§A14)., Serve active or filtered operational incidents as GeoJSON FeatureCollection.… (+4 more)

### Community 54 - "readiness_check"
Cohesion: 0.22
Nodes (10): health_check(), get, Liveness probe to confirm that the FastAPI process is running., Readiness probe checking database connectivity., readiness_check(), HealthResponse, BaseModel, Liveness probe response model. (+2 more)
...
### Community 56 - "DeterministicIndicRuleProcessor"
Cohesion: 0.25
Nodes (8): DeterministicIndicRuleProcessor, Deterministic, lightweight multilingual processor optimized for Render free-…, Verify citizen emotional intensity and anger NEVER inflate physical engineering…, Verify script detection and category resolution across Hindi, Kannada, Tamil,…, Verify unrecognized text returns suggested_category = None and flags human…, test_cold_start_honesty_on_unrecognized_text(), test_emotion_severity_decoupling(), test_multilingual_and_romanized_ingestion()
...
Cohesion: 0.13
Nodes (13): BuhlmannEquityCompensator, Computed Bühlmann credibility and equity gap evaluation., Self-calibrating actuarial equity engine., Initialize compensator with provisional parameters pending empirical…, Compute Bühlmann credibility factor Z_i = n_i / (n_i + K). Cold start: n_i = 0…, r"""Compute expected issue rate \hat{\mu}_i = Z_i * X_bar_i + (1 - Z_i) * \mu_0., r"""Compute the deficit Delta_i = max(0, \hat{\mu}_i - O_i)., Derive priority boost beta_i = min(beta_max, gamma * (Delta_i / (expected_rate… (+5 more)
...
Cohesion: 0.07
Nodes (32): Application configuration via pydantic-settings., postgrest_exceptions, pydantic_settings, pytest, supabase, is_live_supabase_configured(), Live Supabase Phase 12 Exhaustive RLS & Privilege Matrix Audit Test Suite. In…, Check if real Supabase credentials are provided in settings. (+24 more)

### Community 69 - "README.md"
Cohesion: 0.13
Nodes (10): 1. What Was Built, 2. Verification & Test Evidence, Phase 10: Analytics — Ward Report Card, Corporator Digest & Service-Time/ETA Prediction — Implementation Log, 1. What Was Built, 2. Verification & Test Evidence, Phase 11: Citizen Transparency Board, Jan Sunwai Ledger with Differential Privacy, Nagar Pragati & Civic Assistant — Implementation Log, 1. What Was Built, 2. Key Code References for Mandatory Corrections (+2 more)

### Community 70 - "v1/intake.py"
Cohesion: 0.07
Nodes (49): confirm_report_resolution(), dispute_report_resolution(), Any, AsyncSession, get, post, Request, SupabaseClaims (+41 more)
...
### Community 74 - "Phase 13: Security & Performance Hardening — Technical Specification"
Cohesion: 0.50
...
### Community 80 - "test_live_supabase_phase2_rls"
Cohesion: 0.67
...
Cohesion: 0.06
Nodes (31): dependencies, @civicbrain/design-tokens, @civicbrain/ui, gsap, leaflet, react, react-dom, react-router-dom (+23 more)

### Community 82 - "test_dispatch_workflow.py"
Cohesion: 0.12
Nodes (23): asyncio, Unit & Integration Tests for Phase 8 Evidence-Gated Dispatch & Satisfaction…, Verify resolve_work_order rejects whitespace-only notes with 422., Verify field worker attempting to resolve another worker's work order raises…, Verify unauthorized field worker cannot start another worker's work order., Verify resolve_work_order rejects coordinates > 50m away with…, Verify dispatching a work order without token returns 401., Verify citizen confirm returns 404 for invalid tracking token. (+15 more)
...
Cohesion: 0.12
Nodes (16): civicbrain_api_v1, global_unhandled_exception_handler(), lifespan(), get, Request, CivicBrain application entrypoint and ASGI factory., Application lifecycle management., Catches unhandled exceptions, logging internally without leaking stack traces… (+8 more)

### Community 85 - "ui/src/index.ts"
Cohesion: 0.13
Nodes (21): App(), FieldLayout(), OfflineSyncContext, OfflineSyncContextValue, OfflineSyncProvider(), useOfflineSync(), apps_karmi_sahayak_src_index, root (+13 more)

### Community 86 - "test_live_supabase_phase5_nlp"
Cohesion: 0.67
...
Cohesion: 0.05
Nodes (78): configure_category_prior(), get_corporator_digest(), get_incident_eta_prediction(), get_ward_report_card(), list_category_priors(), AsyncSession, date, get (+70 more)
...
Cohesion: 0.17
Nodes (16): create_department(), create_staff_member(), get_representative(), list_departments(), list_organizations(), list_staff_members(), AsyncSession, get (+8 more)

### Community 90 - "SharedQueueTable.tsx"
Cohesion: 0.11
Nodes (21): TrackLookupView(), DepartmentQueueView(), MOCK_OPS_WORK_ORDERS, IncidentQueueView(), MOCK_CITY_INCIDENTS, [2026-09-24] — PROMPT 7 — Representative Screen: Ops Board · Department Queue (apps/staff-console), BaseQueueItem, SharedQueueTable() (+13 more)

### Community 91 - "PrimitivesShowcase.tsx"
Cohesion: 0.07
Nodes (27): packages_ui_src_primitives_index_badge, packages_ui_src_primitives_index_button, packages_ui_src_primitives_index_checkbox, packages_ui_src_primitives_index_chip, packages_ui_src_primitives_index_dialog, packages_ui_src_primitives_index_drawer, packages_ui_src_primitives_index_emptystate, packages_ui_src_primitives_index_errorstate (+19 more)
...
### Community 93 - "test_live_supabase_phase7_causal_cycles_and_centrality"
Cohesion: 0.67
...
### Community 94 - "test_live_supabase_phase8_dispatch_evidence_gate"
Cohesion: 0.67
...
### Community 95 - "test_live_supabase_phase9_sync_and_adjudication_flow"
Cohesion: 0.67
...
### Community 106 - "test_vision_splitting.py"
Cohesion: 0.07
Nodes (37): Organization, Administrative and electoral unit of a ULB representing a Corporator…, Root tenant representing an Urban Local Body (ULB) or multi-ULB state…, Ward, Categorical classification entity governed by living taxonomy rules., TaxonomyCategory, DetectedDefect, FixtureVisionDetector (+29 more)
...
### Community 109 - "CategoryStatus"
Cohesion: 0.19
Nodes (14): approve_category(), list_categories(), propose_category(), AsyncSession, get, patch, post, SupabaseClaims (+6 more)
...
### Community 115 - "test_live_supabase_phase4_gis.py"
Cohesion: 0.20
...
### Community 119 - "test_live_supabase_phase12_exhaustive_rls_matrix"
Cohesion: 0.50
...
Cohesion: 0.10
Nodes (18): Security helpers: CSV formula injection defenses and sanitization., Neutralize spreadsheet formula injection vulnerabilities (CSV Injection /…, sanitize_csv_cell(), 1. Department Creation Endpoint, 1. Executive Summary & Core Requirements, 2. The Six Corrected Design Pillars, 3. Database Schema Changes (`migrations/0015_staff_bulk_import_audit.sql`), 4. API Surface & Schemas (+10 more)

### Community 128 - "identity/models.py"
Cohesion: 0.06
Nodes (56): Authentication and user session endpoints., API endpoints for Phase 7 Causal Root-Cause Linking & Incident Centrality…, Health and readiness diagnostic endpoints., API v1 router registry., NLP Pipeline and Multilingual Ingestion REST Endpoints (§A11)., Living Taxonomy Governance REST Endpoints (§A11, Standing Invariant 1)., Phase 10 Analytics Domain Models: CategoryServiceTimePrior,…, Phase 7 Domain Models: IncidentCausalLink, CausalRelationType. (+48 more)

### Community 129 - "test_live_supabase_rbac_rls"
Cohesion: 0.50
...
Cohesion: 0.05
Nodes (49): App(), apps_nagrik_setu_src_index, root, HomeReportView(), ReportCaptureView(), ReportCategoryView(), ReportLocationView(), ReportReviewView() (+41 more)

### Community 137 - "ui/package.json"
Cohesion: 0.06
Nodes (35): dependencies, @civicbrain/design-tokens, lucide-react, @radix-ui/react-checkbox, @radix-ui/react-dialog, @radix-ui/react-radio-group, @radix-ui/react-select, @radix-ui/react-switch (+27 more)
...
### Community 142 - "SecurityHeadersMiddleware"
Cohesion: 0.17
...
### Community 147 - "Phase 3: Multi-Issue Photo Splitting Pipeline, Living Taxonomy Governance & Computer Vision — Technical Specification"
Cohesion: 0.17
...
## Knowledge Gaps
- **489 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+484 more)
...
- **Why does `[2026-09-24] — PROMPT 4 — Tier 1 Civic-Specific Components (packages/ui)` connect `CivicShowcase.tsx` to `v1/prioritization.py`?**
  _High betweenness centrality (0.249) - this node is a cross-community bridge._
- **Why does `IncidentStatus` connect `IncidentStatus` to `v1/prioritization.py`, `v1/intake.py`, `transparency/services.py`, `v1/dispatch.py`, `v1/gis.py`, `CurrentUserClaims`, `incidents.py`?**
