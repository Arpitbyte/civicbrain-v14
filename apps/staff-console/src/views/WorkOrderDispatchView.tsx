  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between pb-3 border-b border-border">
        <div>
          <h1 className="font-ui text-xl font-semibold text-primary">Work Order Dispatch</h1>
          <p className="font-mono text-xs text-secondary mt-1">Route: /deck/dispatch/new</p>
        </div>
        <div className="flex gap-2">
          ...
          <span key="department_staff" className="font-mono text-xs px-2 py-0.5 bg-surface text-secondary border border-border rounded-sm">department_staff</span>
      ...
      <div className="p-6 border border-dashed border-border rounded-md text-secondary font-mono text-sm">
        Screen scaffold for Work Order Dispatch ready for implementation in later prompts.
