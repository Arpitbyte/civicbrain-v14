  ...
  return (
    <div className="space-y-4">
      <div className="pb-3 border-b border-border">
        <h1 className="font-ui text-xl font-semibold text-primary">New Report Flow — Review & Submit</h1>
        <p className="font-mono text-xs text-secondary mt-1">Route: /report/new/review</p>
      </div>
